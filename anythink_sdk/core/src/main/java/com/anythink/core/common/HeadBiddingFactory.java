...
public class HeadBiddingFactory {
    ...
    public interface IHeadBiddingHandler {
        ...
        void initHbInfo(Context context, String requestId, String unitId, int format, List<PlaceStrategy.UnitGroupInfo> normalUnitInfoList, List<PlaceStrategy.UnitGroupInfo> hbUnitInfoList);
