...
import static com.anythink.core.common.net.ApiRequestParam.GET;
import static com.anythink.core.common.net.ApiRequestParam.POST;
        ...
        Worker worker = new Worker() {
            ...
            private void doUrlConnect(String urlStr) {
                ...
                try {
                    ...
                    if (urlStr.equals(Const.API.URL_APP_STRATEGY) || urlStr.equals(Const.API.URL_PLACE_STRATEGY) || urlStr.contains(Const.API.URL_TRAFFIC_CHECK)) {
...
//                            CommonLogUtil.d(TAG, "data-code:" + code);
                        ...
                        final Object result = onParseResponse(httpConn.getHeaderFields(), sb.toString());
                        onLoadFinishCallback(reqCode, result);
                    }
