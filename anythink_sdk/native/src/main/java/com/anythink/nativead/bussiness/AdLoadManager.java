...
public class AdLoadManager extends CommonAdManager {
     ...
     * @param listener
     */
    public void startLoadAd(final Map<String, Object> localMap, final ATNativeNetworkListener listener) {

        mLocalMap = localMap;
        loadStragety(mApplicationContext, Const.FORMAT.NATIVE_FORMAT, mPlacementId, false, new PlacementCallback() {
            @Override
