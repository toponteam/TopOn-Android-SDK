...
public class ATNativeBannerView extends RelativeLayout {
    ...
    private synchronized void addNativeView(ATNativeBannerListener listener) {
        if (hasCallbackShow) {
            return;
        }
        ...
        if (mATNative != null) {
            ...
            if (nativeAd != null) {
                ...
                if (listener != null) {
                    if (mIsRefresh) {
                        listener.onAutoRefreshFail("No Ad exist.");
                    } else {
                        listener.onAdError("No Ad exist.");
                    }
                }
            }
        } else {
