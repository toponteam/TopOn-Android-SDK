...
public class OwnInterstitialAd extends OwnBaseAd {

    public static final String TAG = OwnInterstitialAd.class.getSimpleName();

    private VideoAdEventListener mListener;

    public OwnInterstitialAd(Context context, OFFER_TYPE offerType, BaseAdRequestInfo ownBaseAdRequestInfo) {
