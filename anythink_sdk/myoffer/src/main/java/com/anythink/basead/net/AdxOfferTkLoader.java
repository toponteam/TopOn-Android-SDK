...
public class AdxOfferTkLoader extends AbsHttpLoader {
    String hostUrl;
    ...
    public AdxOfferTkLoader(int tkType, AdxOffer adxOffer, String trackJSONString, Map<String, Object> replaceMap) {
        this.tkType = tkType;
    ...
    protected String onPrepareURL() {
        ...
        hostUrl = AdxUrlAddressManager.getInstance().getAdxTrackRequestUrl();
