...
public class OwnOfferNoticeUrlLoader extends AbsHttpLoader {
    int tkType;
    String url;
    OwnBaseAdContent adxOffer;
    Map<String, Object> replaceMap;

    public OwnOfferNoticeUrlLoader(int tkType, String url, OwnBaseAdContent adxOffer, Map<String, Object> replaceMap) {
        this.tkType = tkType;
        this.url = url;
    ...
    protected Map<String, String> onPrepareHeaders() {
        if (adxOffer != null) {
            ...
            OwnBaseAdSetting adxAdSetting = adxOffer.getAdSetting();
