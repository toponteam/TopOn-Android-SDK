...
public class PlayerView extends RelativeLayout implements TextureView.SurfaceTextureListener {
    ...
    public void setSetting(BaseAdSetting myOfferSetting) {
    ...
    private void init() {
        ...
        if (error) {
            if (mListener != null) {
                mListener.onVideoShowFailed(OfferErrorCode.get(OfferErrorCode.rewardedVideoPlayError, OfferErrorCode.fail_video_file_error_));
            }
            return;
        }
    ...
    private void computeVideoSize() {
        ...
        try {
            ...
            OfferVideoUtil.Size videoSize = OfferVideoUtil.getAdaptiveVideoSize(mSourceFD, dm.widthPixels, dm.heightPixels);
    ...
    private boolean checkValid() {
        mFileInputStream = OfferResourceManager.getInstance().getInputStream(mSourcePath);
        boolean error = false;
        ...
        if (mMediaPlayer == null) {
            ...
            mMediaPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() {
                ...
                public boolean onError(MediaPlayer mp, int what, int extra) {
                    if (mListener != null) {
                        mListener.onVideoShowFailed(OfferErrorCode.get(OfferErrorCode.rewardedVideoPlayError, OfferErrorCode.fail_player));
                    }
    ...
    private void openPlayer() {
        ...
        try {
            ...
            e.printStackTrace();
            if (mListener != null) {
                mListener.onVideoShowFailed(OfferErrorCode.get(OfferErrorCode.rewardedVideoPlayError, e.getMessage()));
            }
        }
    }
