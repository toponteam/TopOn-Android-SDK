...
public class AdxRewardVideoAd extends AdxBaseAd {

    public static final String TAG = AdxRewardVideoAd.class.getSimpleName();

    private VideoAdListener mListener;
    private AdxAdConfig mAdxAdConfig;

    public AdxRewardVideoAd(Context context, AdxRequestInfo adxRequestInfo) {
