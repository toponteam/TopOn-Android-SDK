...
public class MsgManager {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (isNeedSend && !TextUtils.isEmpty(action)) {//开始发送消息
                            ...
                            sendMsg(action, cm, dt, adsourceId, ((AdTrackingInfo) logBean.adTrackingInfo).getmNetworkType());
                        }
                    } catch (Throwable e) {
    ...
    private void sendMsg(String action, String common, String data, String adsourceId, int networkType) {
        if (mContext == null) {
            return;
        }
