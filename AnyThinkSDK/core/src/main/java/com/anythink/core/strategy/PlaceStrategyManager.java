...
public class PlaceStrategyManager {
    ...
    public static PlaceStrategyManager getInstance(Context context) {
        if (mInstance == null) {
     ...
     * @param placeId
     */
    public void requestStrategy(final PlaceStrategy oldStrategy, final String appId, final String appKey, final String placeId, final Map<String, String> customMap, final StrategyloadListener strategyloadListener) {
        ...
        SDKContext.getInstance().runOnMainThread(new Runnable() {
            ...
            public void run() {
                ...
                if (oldStrategy != null) {
                    /**Check MyOffer Cap**/
                    if (oldStrategy.isPlaceStrategyExpired() || MyOfferAPIProxy.getIntance().checkOffersOutOfCap(mContext, placeId)) { //策略过期
