...
public class AdLoadManager extends CommonAdManager {
     ...
     * @param listener
     */
    public void startLoadAd(final ViewGroup container, final View skipView, final long fetchDelay, final Map<String, String> customExtraMap, final ATSplashAdListener listener) {
        loadStragety(mApplicationContext, Const.FORMAT.SPLASH_FORMAT, mPlacementId, false, customExtraMap, new PlacementCallback() {
            @Override
            public void onSuccess(String placementId, String requestId, PlaceStrategy placeStrategy, List<PlaceStrategy.UnitGroupInfo> unitGroupInfoList) {
                ...
                mediationManager.loadSplashAd(container, skipView, fetchDelay, mPlacementId, requestId, placeStrategy, unitGroupInfoList);
