...
public class MyOfferLoader implements MyOfferUrlLoadManager.ResourceLoadResult {
    ...
    public MyOfferLoader(boolean isPreLoad, int myOfferTimeout) {
    ...
    public void load(MyOfferAd myOfferAd, MyOfferLoaderListener listener) {
        ...
        for (int i = 0; i < url_size; i++) {
            ...
            MyOfferUrlLoader myOfferUrlLoader = new MyOfferUrlLoader(mIsPreLoad, myOfferAd.getOfferId(), url, TextUtils.equals(url, myOfferAd.getVideoUrl()));
