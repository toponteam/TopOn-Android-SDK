...
public class ATHeadBiddingHandler implements HeadBiddingFactory.IHeadBiddingHandler {
    ...
    @Override
    public void initHbInfo(Context context, String unitId, int format, List<PlaceStrategy.UnitGroupInfo> normalUnitInfoList, List<PlaceStrategy.UnitGroupInfo> hbUnitInfoList) {
