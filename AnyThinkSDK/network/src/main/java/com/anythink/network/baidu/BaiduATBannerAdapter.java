...
public class BaiduATBannerAdapter extends CustomBannerAdapter{
    ...
    @Override
    public void loadBannerAd(final ATBannerView bannerView, Context activity, Map<String, Object> serverExtras, ATMediationSetting mediationSetting, CustomBannerListener customBannerListener) {
