...
public class OguryATInitManager extends ATInitMediation {
    ...
    public void initSDK(final Context context, Map<String, Object> serviceExtras, final Callback callback) {
...
//        void onError(String msg);
    ...
    public List getActivityStatus() {
        ...
        list.add("com.ogury.consent.manager.ConsentActivity");
        list.add("io.presage.interstitial.ui.InterstitialActivity");
        list.add("io.presage.interstitial.ui.InterstitialAndroid8TransparentActivity");
        list.add("io.presage.interstitial.ui.InterstitialAndroid8RotableActivity");
        list.add("io.presage.mraid.browser.ShortcutActivity");
        list.add("io.presage.mraid.browser.Android8AndLaterShortcutActivity");
        list.add("io.presage.core.activity.SBActivity");
        return list;
    }
    ...
    public List getServiceStatus() {
        ArrayList<String> list = new ArrayList<>();
        list.add("io.presage.common.profig.schedule.ProfigSyncIntentService");
        list.add("io.presage.common.profig.schedule.ProfigJobService");
        list.add("io.presage.core.service.SdkService");
        list.add("io.presage.core.service.SdkJobService");
        list.add("io.presage.core.service.SMJobService");
        return list;
    }
