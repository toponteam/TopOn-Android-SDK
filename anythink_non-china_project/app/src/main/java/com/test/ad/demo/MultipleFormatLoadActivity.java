...
public class MultipleFormatLoadActivity extends Activity implements View.OnClickListener {
    ...
    private String mNativePlacementId = DemoApplicaion.mPlacementId_native_admob;
    private String mBannerPlacementId = DemoApplicaion.mPLacementId_banner_kidoz;
    private String mRewardVideoPlacementId = DemoApplicaion.mPlacementId_rewardvideo_kidoz;
    private String mInterstitialPlacementId = DemoApplicaion.mPlacementId_interstitial_kidoz;
